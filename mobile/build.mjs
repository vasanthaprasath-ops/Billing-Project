...
for (const f of ["pdf.js", "zip.js", "backend.js", "bridge.js", "m3.js", "feel.js", "scan.js"]) copyFileSync(join(here, "src", f), join(www, "js", "local", f));
...
replaceOnce('<script src="/js/app.js"></script>', [
    ...
    '<script src="/js/local/scan.js"></script>',
].join("\n"));
